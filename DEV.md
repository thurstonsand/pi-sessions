...
- **Subagents**: `extensions/subagents/install.ts`; ledger-derived identity, tmux launch and wake behavior, task reporting, classification, roster traversal, and lifecycle reconciliation at `extensions/subagents/`.
